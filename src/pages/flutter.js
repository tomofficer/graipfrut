...
const WebDevelopment = () => {
  ...
  const [textTitle] = useState({
    sectionTitle: 'Flutter App Development',
    sectionDescription:
  ...
  const [services] = useState({
    sectionTitle: 'The Roadmap To Flutter App Success',
    data: [
      {
        id: 1,
        title: 'Sprint',
              ...
              <div className='ctn-box'>
                <div className='sec-title line-left'>
                  <h2 data-aos='fade-down' data-aos-delay='50'>
                    Empowering Your Business With Flutter
                    <i class='fas fa-mobile-android-alt    '></i>
                  </h2>
                </div>
                <div className='sub-title'>
                  <h3 data-aos='fade-down' data-aos-delay='50'>
                    Unlock Your Business' Full Potential With Flutter
                  </h3>
                </div>
